...
- Live preview as you type — headings render large, bullets render as bullets, images render inline
- Toggle between live preview and raw markdown with `Cmd+Shift+M`
- Saves transparently back to the `.md` file
